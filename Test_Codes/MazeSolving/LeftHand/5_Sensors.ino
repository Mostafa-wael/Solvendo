 ...
 * @brief Thresholds
 */
#define THRESHOLD_W 450 // above it is white and below it all black
...
{
    Serial.print("Abs Values ");
    Serial.print(analogRead(IR_LL) > THRESHOLD_W);
    Serial.print(" ");
    Serial.print(analogRead(IR_L) > THRESHOLD_W);
    Serial.print(" ");
    Serial.print(analogRead(IR_C) > THRESHOLD_W);
    Serial.print(" ");
    Serial.print(analogRead(IR_R) > THRESHOLD_W);
    Serial.print(" ");
    Serial.println(analogRead(IR_RR) > THRESHOLD_W);
}
...
void movecar2()
{
    ...
    if (!LL)
        llIsBlack++, llIsWhite = 0;
    else
        llIsBlack = 0, llIsWhite++;

    if (!RR)
        rrIsBlack++, rrIsWhite = 0;
    else
        rrIsBlack = 0, rrIsWhite++;
